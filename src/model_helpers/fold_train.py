...
from src.model_helpers.one_class import OneClassModel, train_fold_one_class
...
def fold_train(
    model_name: OneClassModel | ClassicalModel | DLModel,
    dataset_type: str,
...
def _get_fold_metrics(
    model_name: OneClassModel | ClassicalModel | DLModel,  # <--- Updated Union
    x_train: np.ndarray,
    y_train: np.ndarray,
    ...
    match model_name:
        ...
        case DLModel():
            return _get_fold_metrics_dl(model_name, x_train, y_train, train_index, val_index)
