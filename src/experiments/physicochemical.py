...
RANDOM_STATE = 50
TRAIN_BALANCED_PATH   = Path("data/processed/dataset_CPP_1to1_train.csv")
TRAIN_IMBALANCED_PATH = Path("data/processed/dataset_CPP_1to2_train.csv")
TEST_BALANCED_PATH    = Path("data/processed/dataset_CPP_1to1_test.csv")
TEST_IMBALANCED_PATH  = Path("data/processed/dataset_CPP_1to2_test.csv")
OUTPUT_DIR = Path("results/physicochemical")
...
def run_single_experiment(train_df, test_df, model_name, dataset_type):
    ...
    mean_row = {"model": model_name, "representation": "Physicochemical",
                "dataset": dataset_type, "stage": "cv_mean"}
    std_row  = {"model": model_name, "representation": "Physicochemical",
    ...
    test_row = {
        "model": model_name, "representation": "Physicochemical",
...
# Model 13: SVM,               Physicochemical, balanced
# Model 14: SVM,               Physicochemical, imbalanced
# Model 15: Random Forest,     Physicochemical, balanced
# Model 16: Random Forest,     Physicochemical, imbalanced
# Model 17: Gradient Boosting, Physicochemical, balanced
# Model 18: Gradient Boosting, Physicochemical, imbalanced
configs = [
...
for model_name, dataset_type, train_df, test_df in configs:
    fold_results, summary = run_single_experiment(
        train_df, test_df, model_name, dataset_type
    )
...
print("Models 13-18 (Physicochemical) experiments completed.")
print(final_summary)
