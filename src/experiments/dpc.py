...
def run_single_experiment(train_df, test_df, model_name, dataset_type):
    ...
    # Trenowanie na pełnym zbiorze treningowym i ewaluacja na testowym
...
for dataset_type, paths in DATA_PATHS.items():
...
final_folds.to_csv(OUTPUT_DIR / "classic_ml_dpc_cv_folds.csv", index=False)
