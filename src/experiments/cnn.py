...
from src.experiments.mlp import EMBEDDINGS_MEAN_DIR
...
def load_embeddings(dataset_type):
    X_train = np.load(EMBEDDINGS_MEAN_DIR / f"train_{dataset_type}_X.npy")  # noqa: N806
    y_train = np.load(EMBEDDINGS_MEAN_DIR / f"train_{dataset_type}_y.npy")
    X_test = np.load(EMBEDDINGS_MEAN_DIR / f"test_{dataset_type}_X.npy")
    y_test = np.load(EMBEDDINGS_MEAN_DIR / f"test_{dataset_type}_y.npy")
